...
export function AlertDialog({ open, onConfirm, onCancel, title, description }: { open: boolean; onConfirm: () => void; onCancel: () => void; title: string; description?: string }) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="va-alert relative z-10 w-full max-w-md rounded-lg border p-4 shadow-xl bg-white text-neutral-900 border-neutral-200 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-100">
